  ...
  return (
    <div className="schedule-page animate-fade-in">
      <div className="section-header" style={{ marginBottom: '24px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
        <span className="section-title" style={{ fontFamily: 'var(--font-heading)', color: 'var(--color-primary)', fontSize: '1.2rem', display: 'flex', alignItems: 'center', gap: 10 }}>
          <Calendar size={20} /> Lịch trình Hoạt động
        </span>
